 ...
 */
define( 'HOCWP_THEME_REQUIRED_PLUGINS', 'wordpress-popular-posts' );
 ...
 */
define( 'HOCWP_THEME_RECOMMENDED_EXTENSIONS', 'improve-search,dynamic-thumbnail' );
...
add_filter( 'hocwp_theme_load_default_style', '__return_false' );